...
class CreateLampiranChangeOwnershipRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
         ...
         $survey = OutletChangeOwnership::where(array('id_outlet_change_ownership'=>$value,'status'=>"Process"))->orwhere(array('status'=>"Waiting"))->first();
         if($survey){
             return true;
         } return false;
        }); 
