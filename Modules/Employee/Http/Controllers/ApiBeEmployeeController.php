                ...
                if(!empty($post['data_document'])){
                    ...
                    if($post['data_document']['document_type']=='Interview Invitation'){
                        ...
                        $autocrm = app($this->autocrm)->SendAutoCRM(
                            ...
                            $getData->phone,
                            [
                                'date_invitation'=>date('Y-m-d H:i:s', strtotime($post['data_document']['process_date']??date('Y-m-d H:i:s'))),
                                'time_invitation'=>date('Y-m-d H:i:s', strtotime($post['data_document']['process_date']??date('Y-m-d H:i:s'))),
