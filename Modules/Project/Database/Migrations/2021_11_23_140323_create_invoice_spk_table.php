...
class CreateInvoiceSpkTable extends Migration
{
    public function up()
    {
        Schema::create('invoice_spk', function (Blueprint $table) {
            $table->increments('id_invoice_spk');
            $table->integer('id_project')->unsigned();
            $table->foreign('id_project', 'fk_project_invoice_spk')->references('id_project')->on('projects')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('invoice_spk');
    }
}
