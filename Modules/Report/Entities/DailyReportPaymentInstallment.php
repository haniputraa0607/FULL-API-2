 ...
 */
class DailyReportPaymentInstallment extends Eloquent
{
	protected $table = 'daily_report_payment_installment';
	protected $primaryKey = 'id_daily_report_payment_installment';
