...
class NewTransactionV2 extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'type'                     => 'nullable|in:Delivery,Pickup Order,GO-SEND,Advance Order,Delivery Order',
...
//            'pickup_at'                => 'required_if:pickup_type,set time|date_format:Y-m-d H:i:s',
            'payment_type'             => 'nullable|in:Cash,Midtrans,Manual,Balance,Ovo,Ipay88,Shopeepay,Xendit',
