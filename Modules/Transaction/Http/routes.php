...
Route::group(['middleware' => ['auth:api', 'log_activities', 'user_agent', 'scopes:be'], 'prefix' => 'api/transaction', 'namespace' => 'Modules\Transaction\Http\Controllers'], function () {
    ...
    Route::group(['prefix' => 'outlet-service'], function () {
	    ...
	    Route::post('manage', ['middleware' => 'feature_control:392', 'uses' => 'ApiTransactionOutletService@manageList']);
	    Route::get('manage/detail/{id_transaction}', ['middleware' => 'feature_control:393', 'uses' => 'ApiTransactionOutletService@manageDetail']);
	    Route::post('manage/detail/{id_transaction}', ['middleware' => 'feature_control:394', 'uses' => 'ApiTransactionOutletService@manageDetailUpdate']);
    });
