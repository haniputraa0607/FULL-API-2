...
class DealsPromotionTemplate extends Model
{
	...
	public function deals_promotion_services()
    {
			return $this->hasMany(\Modules\Deals\Entities\DealsPromotionTemplateService::class, 'id_deals', 'id_deals_promotion_template');
	}
