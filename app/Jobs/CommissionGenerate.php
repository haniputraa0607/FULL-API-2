...
class CommissionGenerate implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $datas = app('Modules\Transaction\Http\Controllers\ApiTransactionProductionController')->breakdownCommissionQueue();
        return true;
