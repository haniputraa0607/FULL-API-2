          ...
          29 =>
            ...
            95 =>
                array (
                    ...
                    'autocrm_forward_email_content' => 'Hello %name%, a new request product form has been created',
            ...
            96 =>
                array (
                    ...
                    'autocrm_forward_email_content' => 'Hello %name%, an item of a request product form has been updated',
                    'custom_text_replace'=> NUll,
                    'created_at' => date('Y-m-d H:i:s'),
                    'updated_at' => date('Y-m-d H:i:s'),
                ),
            97 =>
                array (
                    ...
                    'autocrm_forward_email_content' => 'Hello %name%, a new receipt log has been created',
                    'custom_text_replace'=> NUll,
                    'created_at' => date('Y-m-d H:i:s'),
                    'updated_at' => date('Y-m-d H:i:s'),
                ),
            98 =>
                array (
                    ...
                    'autocrm_inbox_toogle' => '1',
                    'autocrm_forward_toogle' => '1',
                    'autocrm_email_subject' => 'Create Receipt Log',
                    'autocrm_email_content' => 'Hello %name%, a new receipt log has been created',
                    'autocrm_sms_content' => 'Hello %name%, a new receipt log has been created',
                    'autocrm_push_subject' => 'Create Receipt Log',
                    'autocrm_push_content' => 'Hello %name%, a new receipt log has been created',
                    'autocrm_push_image' => NULL,
                    'autocrm_push_clickto' => NULL,
                    'autocrm_push_link' => NULL,
                    'autocrm_push_id_reference' => NULL,
                    'autocrm_inbox_subject' => 'Create Receipt Log',
                    'autocrm_inbox_content' => 'Hello %name%, a new receipt log has been created',
                    'autocrm_forward_email' => NULL,
                    'autocrm_forward_email_subject' => 'Create Receipt Log',
                    'autocrm_forward_email_content' => 'Hello %name%, a new receipt log has been created',
                    'custom_text_replace'=> NUll,
